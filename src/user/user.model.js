...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function (_super) {
        ...
        function User_1() {
            ...
            _this.nome = __runInitializers(_this, _nome_initializers, void 0);
    ...
    (function () {
        ...
        _nome_decorators = [sequelize_typescript_1.Column];
        _email_decorators = [sequelize_typescript_1.Column];
        _password_decorators = [sequelize_typescript_1.Column];
